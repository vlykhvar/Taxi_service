...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("All the characters and events depicted are fictitious. Any resemblance to a person living or dead is purely coincidental");
        ...
        System.out.println("How to work update: " + (manufacturerService.update(manufacturerHonda)).toString());
        ...
        System.out.println("Here we have: " + driverService.getAll().toString());
        ...
        System.out.println("We have park of auto: " + carService.getAll().toString());
        ...
        System.out.println("Driver Bogdan ride on " + carService.getAllByDriver(driverBogdan.getId()).toString());
        System.out.println("But Bogdan diced not to work on " + carVida.toString());
        carService.removeDriverFromCar(driverBogdan, carVida);
        System.out.println("His new list of work car is " + carService.getAllByDriver(driverBogdan.getId()).toString());
